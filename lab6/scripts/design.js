$(document).ready(function() {
  ...
  $('.nav-link').on('click', function(e) {
    ...
    //------------------------//
    /* after the cover, 
       1 = home, 2 = fashion, 3 = jewellery, 4 = tech, 5 = basket */
    //------------------------//
    if (href === '#home') $('.flipbook').turn('page', 1);
    if (href === '#fashion') $('.flipbook').turn('page', 2);
    if (href === '#jewellery') $('.flipbook').turn('page', 3);
    if (href === '#hardware') $('.flipbook').turn('page', 4);
